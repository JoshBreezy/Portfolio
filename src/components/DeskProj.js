    ...
    return (
        <>
            <div className='row flex-nowrap overflow-auto' style={{scrollBehavior: 'smooth'}} ref={ref}>
                <button className="carousel-control-prev h-25" style={{top: '40%'}} type="button" onClick={() => scroll(-300)}>
                ...
                <button className="carousel-control-next h-25" style={{top: '40%', right: '-.5%'}} type="button" onClick={() => scroll(300)}>
